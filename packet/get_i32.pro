;Read a 32-bit signed integer from a BIG-ENDIAN byte stream
;  Input
;    data - array of bytes containing big-endian data
;    idx  - scalar or array of indices of first byte(s) to pull i32(s) from
;  Ouput 
;    32-bit signed integer(s) either scalar or array of same size as idx
;Note:
