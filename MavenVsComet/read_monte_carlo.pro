...
;  bdott=bdott[0:100]
  ...
  loadct,39
  erase,color=255  
  plot,bdott,bdotr,psym=3,color=0,xrange=[-2d4,1d4],yrange=[1d4,-4d4],/iso,/xs,/ys,xtitle="B.t km",ytitle="B.r km",charsize=2,title="Monte Carlo uncertainty",background=255
